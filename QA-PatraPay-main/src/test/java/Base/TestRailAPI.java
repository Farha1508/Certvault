...
public class TestRailAPI {
    ...
    private final Properties trail = new Properties();
    ...
    public TestRailAPI() {
        ...
        if (testRailRun) {
            ...
            String runTitle = config.getProperty("environment").toUpperCase() +" "+ trail.getProperty("runTitle") + " - " +dateString;
            ...
            if (trail.getProperty("createrun").equals("true") && !runExists) {
    ...
    public void createRun(int projId, String runTitle) {
        ...
        String[] sections = trail.getProperty("sectionIds").split(",");
        try {
