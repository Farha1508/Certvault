Feature: Demonstration of DataTable utilization
  ...
  Scenario: Basic information page happy path- Step 1st
    ...
    When I enter the email and password for the "Carrier" user
  ...
  Scenario: Using DataTable with titles on top and entry underneath
    Given I am on the login page
    When I enter the email and password for the "Agency" user
    And I click the Sign In button
    And I open the New Application form
    And I edit the following fields
      | Business Name      | Zip Code | First Name | Last Name | Email                   | Phone      |
      | Test Business Name | 98666    | TestFirst  | TestLast  | testemail@patracorp.net | 5555555555 |
