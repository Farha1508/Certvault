...
public class KPISteps extends BaseUtil {
    ...
    public void theFollowingKPIsExist(List<String> KPIs) {
        for(String KPI:KPIs){
            System.out.println("Checking that the "+KPI+" KPI exists.");
            Assert.assertTrue(commonKPI.KPIExists(KPI));
        }
    }

    @Then("The folowing KPIs do not exist")
    public void theFolowingKPIsDoNotExist(List<String> KPIs) {
        for(String KPI:KPIs){
            System.out.println("Checking that the "+KPI+" KPI does not exist.");
            Assert.assertFalse(commonKPI.KPIExists(KPI));
        }
    }
}
